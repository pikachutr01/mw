...
| **Tatil modu** | ✅ **sunucu tarafı** (2026-08-02) — `apps/api/src/vacation/`, göç 0035, 21 test. `GET/POST /api/v1/vacation{,/enter,/leave}` · 48 sa alt sınır · 30 gün üst sınır + `vacation_end` görevi · 3 gün yeniden giriş beklemesi · ön-şart listesi (kuyruk · giden/gelen/dönen ordu · ceza · bekleme) · **kaynak birikimi ve üretim tamamen durur** · tatildeyken sefer/kuyruk/mağara/diriltme `on_vacation` (403). ⛔ **Arayüzü henüz yok** |
