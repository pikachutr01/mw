 ...
 *
 *   node --env-file=../../.env scripts/notify-poke.mjs <kullanıcıAdı> [attack|spy|production|invite|battle]
 *
...
const ROWS = {
  ...
  battle: ['battle:resolved', {
    battleId: 99003, attackerPlayerId: id, defenderPlayerId: id, winner: 'attacker', cityId: 1,
  }],
};
